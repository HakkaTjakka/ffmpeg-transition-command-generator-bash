bin/ffmpeg \
-i "mp4_3840x2160/out.01.mp4" \
-i "mp4_3840x2160/out.02.mp4" \
-i "mp4_3840x2160/out.03.mp4" \
-i "mp4_3840x2160/out.04.mp4" \
-i "mp4_3840x2160/out.05.mp4" \
-filter_complex " \
[0:v]split[v0a][v0b]; \
